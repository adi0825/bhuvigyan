...
$names = @('gateway','location-service','farmer-service','admin-service','claims-service','notification-service','kyc-service','report-service','insurer-service','cce-service','carbon-service','analytics-service','scheduler-service','csc-service','officer-service','state-service')
